...
import Genies from "../../../assets/images/Genies.png";
import Netpulse from "../../../assets/images/Netpulse.png";
import Starway from "../../../assets/images/Starway.png";
...
class App {
  ...
  onCheckDebounce: (...args: Parameters<typeof debounce>) => void;
  renderer!: Renderer;
  gl!: GL;
  camera!: Camera;
  scene!: Transform;
  ...
  createMedias(
    ...
    const defaultItems = [
      {
        image: `https://www.nicholsonrj.com/Picture.84ec4241.webp`,
        text: "Artsync",
      },
      {
        image: Genies,
  ...
  onWheel() {
    ...
    this.onCheckDebounce(() => this.onCheck(), 200);
  }
