  ...
  return (
    ...
    >
      ...
      <section className="relative mb-10 py-5 text-white" id="contact">
        <div className="relative mx-auto flex max-w-6xl flex-col gap-10 overflow-hidden rounded-lg bg-gradient-to-bl from-zinc-800/40 to-zinc-950/40 px-4 py-8 shadow-md">
