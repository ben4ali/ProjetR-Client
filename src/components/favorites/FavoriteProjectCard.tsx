...
export const FavoriteProjectCard = ({
  ...
  return (
    <Link to={`/watch/${project.id}`}>
      <div className="flex gap-4">
        {/* Thumbnail */}
        <div className="relative w-40 h-24 bg-gradient-to-br from-gray-100 to-gray-200 rounded-lg overflow-hidden flex-shrink-0">
          {project.demoUrl ? (
            <video
          ...
          <div className="absolute top-1 right-1">
            <div className="bg-red-500 text-white px-1.5 py-0.5 rounded text-xs font-medium flex items-center">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-sm text-gray-600 mb-2 truncate max-w-[70%]">
            {project.description}
          </p>
